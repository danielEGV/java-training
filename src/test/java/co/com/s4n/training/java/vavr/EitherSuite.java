...
public class EitherSuite {
    ...
    public void swapToEither_1() {
        ...
        assertFalse( myEitherR.isLeft(), "Valide swap before in Either Right");
        assertFalse(myEitherR.swap().isRight(), "Valide swap after in Either Right");
        assertFalse(myEitherL.isRight(), "Valide swap before in Either Left");
        assertFalse(myEitherL.swap().isLeft(), "Valide swap after in Either Right");
    }
    ...
    public void testProjection_1(){
        ...
        //El Either para operar el lado izquierdo se debe usar un mapLeft.
        assertEquals(Left(5), e2.map(it -> it + 5), "Failure - Left Projection");
    }
    ...
    public void testOrElseRun() {
        ...
        assertEquals(
                "let's dance! ", result[0], "Valide swap before in Either Right");
